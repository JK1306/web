                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-description">
                                Enter the Amount Deposited in  Account
                            </p>
                            ...
                            <span class="input-group-text bg-transparent">
                              <i class="mdi mdi-note-multiple text-white"></i>
                                        ...
                                        <input type="text" class="form-control" placeholder="Description (Optional)" aria-label="Username" name="desc" aria-describedby="colored-addon1">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Amount for deposit" name="amount" aria-label="Amount (to the nearest dollar)">
                              ...
                              <br>
                                <input type="submit" class="btn btn-warning btn-fw btn-lg" name="deposit" value="Proceed">
                            </form>
                        </div>
                    </div>
                </div>
